# PDF Question Answer Bot - Simple RAG

## Project Overview

PDF Question Answer Bot - Simple RAG is a complete full-stack AI project for **Simple RAG**. It includes a FastAPI backend, a React frontend, sample documents, vector search with ChromaDB support, source citations, timeline logs, structured run storage, Docker files, and tests.
...
```text
ai-simple-rag-pdf-question-answer-bot/
  backend/
    app/
      main.py
      config.py
